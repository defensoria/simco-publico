...
public class SimcoFacade {
    ...
    public List<Object[]> reporteActividad(ReporteSimcoActividad reporteSimcoActividad) {
        ...
        sb.append("LEFT JOIN SIMCO_REPORTE_ACTIVIDAD I ON A.N_ID_ACONTECIMIENTO = I.N_ID_ACTIVIDAD AND I.C_TIPO = 'AC' ");
        sb.append("LEFT JOIN SIMCO_REPORTE_ACTIVIDAD_ACTOR L ON A.N_ID_ACTIVIDAD = L.N_ID_ACTIVIDAD  ");
        sb.append("LEFT JOIN SIMCO_REPORTE_ACTOR M ON M.N_ID_ACTOR = L.N_ID_ACTOR ");
        sb.append("WHERE 1 = 1 ");
    ...
    public List<Object[]> reporteVictima(ReporteSimcoVictima reporteSimcoVictima) {
        ...
        sb.append("LEFT JOIN SIMCO_REPORTE_ACTIVIDAD_ACTOR J ON J.N_ID_ACTIVIDAD = D.N_ID_ACTIVIDAD ");
        sb.append("LEFT JOIN SIMCO_REPORTE_ACTOR K ON K.N_ID_ACTOR = J.N_ID_ACTOR ");
    ...
    public List<Object[]> reporteActor(ReporteSimcoActor reporteSimcoActor) {
        ...
        sb.append("LEFT JOIN SIMCO_REPORTE_ACTIVIDAD_ACTOR C ON A.N_ID_ACTOR = C.N_ID_ACTOR ");
        sb.append("LEFT JOIN SIMCO_REPORTE_CASO_ACTIVIDAD D ON C.N_ID_ACTIVIDAD = D.N_ID_ACTIVIDAD ");
        sb.append("LEFT JOIN SIMCO_REPORTE_CASO E ON D.N_ID_CASO = E.N_ID_CASO AND E.C_INDVIGENTE= 'A' ");
        sb.append("LEFT JOIN ( ");
