 ...
 * @author carlos
 */
public class ReporteSimcoInicioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idSelectAnho = request.getParameter("idSelectAnho");
        if(idSelectAnho == null)
            idSelectAnho = "2017";
        cargarGraficos003(request, idSelectAnho);
