...
import gob.pe.defensoria.ejb.FormularioVirtualBKFacade;
 ...
 * @author carlos
 */
@WebServlet(name = "ReportesSIMCO", urlPatterns = {"/ReportesSIMCO"})
@MultipartConfig
public class ReportesSIMCO extends HttpServlet {

    @EJB
    private FormularioVirtualFacade facade;
    
    @EJB
    private FormularioVirtualBKFacade bKFacade;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (persona == null) {
            ...
            guardar(fv);
            response.sendRedirect("https://puma.defensoria.gob.pe/respuesta1.php");
        }
    }
