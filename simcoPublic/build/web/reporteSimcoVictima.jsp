                            ...
                            <td style="width: 60%; vertical-align: top">
                                ...
                                <div class="row titlecatgen marginbp2">
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="width:70%">
                                                <h2 class="titlecat1">Reporte de víctimas de la violencia</h2>
                                            </td>
                                ...
                                <div style="background: #E2E2E2" class="panel panel-primary">
                                    <div class="panel-heading">
                                        <span style="font-size: 150%; font-weight: bold">Búsqueda de víctimas de la violencia</span>
                                    </div>
                                    ...
                                    <div class="panel-footer" style="text-align: right">
                                        ...
                                        &#160;&#160;&#160;
                                        <button class="btn btn-primary simcoButton" id="btnBuscar" name="btnBuscar" value="buscar" onclick="return buscarVictimas()">
