...
<html lang="es">
    ...
    <section>
        ...
        <form id="idForm" method="post" action="reporteSimcoActividad">
            <div class="container">
                            ...
                            <td style="width: 60%; vertical-align: top">
                                ...
                                <div class="row titlecatgen marginbp2">
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="width:70%">
                                                <h2 class="titlecat1">Reporte de acontecimientos y actuaciones defensoriales</h2>
                                            </td>
                                ...
                                <div style="background: #E2E2E2" class="panel panel-primary">
                                    <div class="panel-heading">
                                        <span style="font-size: 150%; font-weight: bold">Búsqueda de actuaciones defensoriales / acontecimientos</span>
                                    </div>
                                                ...
                                                <td>
                                                    <table style="width: 100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn-sm btn-danger" id="idOpenModal">
                                    ...
                                    <div class="panel-footer" style="text-align: right">
                                        ...
                                        <button class="btn btn-primary simcoButton" id="btnBuscar" name="btnBuscar" value="buscar" onclick="return buscarActividades()">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <ul class="pager">
                                        <li>
                                            <a id="idPaginatorOld">Anterior

                                            </a>
                                        </li>
                                        <li>
                                            <a id="idPaginatorNext">Siguiente
                    ...
                    <script type="text/javascript">
                        ...
                        p.Mostrar();
                            ...
                            $('#idOpenModal').click(function () {
                                ...
                                $('#nroPaginaCaso').val(0);
                                $('#nombreCaso').val("");
                                $('#idPaginatorOld').css('display', 'none');
                                $('#idPaginatorNext').css('display', 'none');
                                $('#idTotal').text('');
                            ...
                            $('#idPaginatorNext').click(function (){
                                $('.ctr').remove();
                                $.ajax({
                                    type: "post",
                                    url: "ServletAjax",
                                ...
                                if (parseInt($('#nroPaginaCaso').val()) < 1) {
                                    ...
                                    $('#idPaginatorOld').css('display', '');
                                }
                            });

                            $('#idPaginatorOld').click(function () {
                                $('.ctr').remove();
                                if (parseInt($('#nroPaginaCaso').val()) > 1) {
                                    $.ajax({
                                        type: "post",
